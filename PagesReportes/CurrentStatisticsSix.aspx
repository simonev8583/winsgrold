...
FWTs.ASDU as [Asdu],
LogCorrienteSIXs.Fecha as [Fecha],
LogCorrienteSIXs.ValorIL as [ValorCorriente]
FROM FCIs JOIN LogCorrienteSIXs on (FCIs.Id = LogCorrienteSIXs.SIXId)
JOIN FWTs on (FCIs.FWTId = FWTs.Id)
WHERE LogCorrienteSIXs.Fecha between @fechai and @fechaf 
ORDER BY LogCorrienteSIXs.Fecha DESC">
            <SelectParameters>
...
FROM FCIs JOIN LogCorrienteSIXs on (FCIs.Id = LogCorrienteSIXs.SIXId)
JOIN FWTs on (FCIs.FWTId = FWTs.Id)
WHERE (LogCorrienteSIXs.Fecha between @Finicial and @Ffinal)
...
ORDER BY LogCorrienteSIXs.Fecha DESC" CancelSelectOnNullParameter="False">
    <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataGrafOneSixCte" runat="server" 
                    ...
                    SelectCommand="select 
LogCorrienteSIXs.Fecha as [Fecha],
CONVERT(decimal(15,1), LogCorrienteSIXs.ValorIL/10.0) as [ValorCorriente]
FROM LogCorrienteSIXs
WHERE LogCorrienteSIXs.Fecha between @Finicial and @Ffinal
and LogCorrienteSIXs.SIXId = @SixId
ORDER BY LogCorrienteSIXs.Fecha ASC
">
                    <SelectParameters>
                        <asp:Parameter Name="Finicial" />
                        <asp:Parameter Name="Ffinal" />
