            ...
            <table style="width: 100%;" border="0">
                <tr>
                    <td align="center" bgcolor="#eeeeee">
                        <font><strong><asp:Label ID="lblSerialFCI" Text="<%$ Resources:TextosGlobales,TextoSerialEquipo %>" runat="server"  /></strong></font> 
            ...
            <table style="width: 100%;" border="0">
                ...
                <tr>
                    <td align="center" bgcolor="#eeeeee" colspan="6" width="38%" >
                       <font><strong><asp:Label ID="lblGestionElectrica" Text="<%$ Resources:TextoGestionElectrica %>"  runat="server"></asp:Label> </strong></font>  
                    </td>
                </tr>
                                <tr>
            ...
            <table style="width: 100%;" border="0">
               <tr>
                    <td align="center" bgcolor="#eeeeee" colspan="8" >
                       <font><strong>
                           <asp:Literal ID="Literal2" Text="<%$ Resources:TextTittleParametros %>" runat="server"></asp:Literal> </strong></font>    
                    </td>
                </tr>
                <tr>
