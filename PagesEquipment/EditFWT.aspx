        ...
        <div class="centerDiv">
            <table style="width: 100%;" border="0">
                <tr>
                    <td align="center" bgcolor="#eeeeee">
                        <font><strong><asp:Literal ID="Literal1" Text="<%$ Resources:TextosGlobales,TextoSerialFWT %>" runat="server"></asp:Literal></strong></font>:
            ...
            <table style="width: 100%;" border="0">
             ...
             <table style="width: 100%;" border="0">
                <tr>
                    <td align="center" bgcolor="#eeeeee">
                        <font><strong><asp:Literal ID="Literal2" Text="<%$ Resources:TextTittleEstadoConcentrador %>" runat="server"></asp:Literal></strong></font>
            ...
            <table style="width: 100%;" border="0">
                <tr>
                    <td align="center" bgcolor="#eeeeee">
                        <font><strong><asp:Literal ID="Literal4" Text="<%$ Resources:TextEquiposMatriculados %>" runat="server"></asp:Literal></strong></font>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td align="left" width="15%" >
                                    <asp:ListBox ID="listBoxFCIsPropios" runat="server" CssClass="listInUsuario" Height="70px">
                                    </asp:ListBox>
                                </td>
            ...
            <table border="0" width="100%" >
                <tr>
                    <td align="center" bgcolor="#eeeeee" width="100%">
                        <font><strong><asp:Literal ID="Literal10" Text="<%$ Resources:TextTittleAdminFirmwareDevRt %>" runat="server"></asp:Literal></strong></font>
                    </td>
                </tr>
                <tr>
            ...
            <table border="0" width="100%" >
                <tr>
                    <td align="center" bgcolor="#eeeeee" colspan="2" width="7%">
                        <font><strong><asp:Literal ID="Literal5" Text="<%$ Resources:TextTittleUbicacion %>" runat="server"></asp:Literal></strong></font>
                    </td>
                    <td align="center" bgcolor="#eeeeee" colspan="2" width="13%">
                        <font><strong><asp:Literal ID="Literal6" Text="<%$ Resources:TextGestionElectrica %>" runat="server"></asp:Literal></strong></font>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top" width="11%">
                        ...
                        &nbsp;<asp:TextBox ID="txtAPN" runat="server" CssClass="textInUsuario" 
                ...
                <tr>
                    ...
                    <td width="15%">
                        ...
                        <asp:NumericUpDownExtender runat="server" TargetButtonUpID="" TargetButtonDownID=""
                            ...
                            RefValues="" Width="50" Tag="" Enabled="True" TargetControlID="txtCanalRF" ID="NumericUpDownExtenderCanalRF">
                    ...
                    <td align="center"  valign="top" style="width: 50%;" >
                        ...
                        <ContentTemplate> 
                            <asp:Timer ID="tmrActFirmware" runat="server" Enabled="false" Interval="1000" 
                                ontick="tmrActFirmware_Tick"></asp:Timer>
